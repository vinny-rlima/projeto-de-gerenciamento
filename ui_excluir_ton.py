...
################################################################################
## Form generated from reading UI file 'ui_excluir_ton.ui'
##
...
class Ui_Excluir_ton(object):
    def setupUi(self, Excluir_ton):
        if not Excluir_ton.objectName():
            Excluir_ton.setObjectName(u"Excluir_ton")
        Excluir_ton.resize(867, 585)
        Excluir_ton.setStyleSheet(u"background-color: rgb(0, 80, 121);")
        self.horizontalLayout = QHBoxLayout(Excluir_ton)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.frame = QFrame(Excluir_ton)
...
"}")
        ...
        self.line_2 = QFrame(Excluir_ton)
        ...
        self.widget = QWidget(Excluir_ton)
...
"}")
        ...
        self.retranslateUi(Excluir_ton)

        QMetaObject.connectSlotsByName(Excluir_ton)
    # setupUi

    def retranslateUi(self, Excluir_ton):
        Excluir_ton.setWindowTitle(QCoreApplication.translate("Excluir_ton", u"Dialog", None))
        self.label_4.setText(QCoreApplication.translate("Excluir_ton", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">Excluir</span></p><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">dados</span></p></body></html>", None))
        self.bnt_voltarx.setText(QCoreApplication.translate("Excluir_ton", u"Voltar", None))
        self.label_2.setText(QCoreApplication.translate("Excluir_ton", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; color:#ffffff;\">Insira o ID do tonner que ser\u00e1 excluido:</span></p></body></html>", None))
        self.bnt_excluirx.setText(QCoreApplication.translate("Excluir_ton", u"Excluir", None))
    # retranslateUi
