...
################################################################################
## Form generated from reading UI file 'ui_cadastro_es.ui'
##
...
class Ui_CADASTRO_es(object):
    def setupUi(self, CADASTRO_es):
        if not CADASTRO_es.objectName():
            CADASTRO_es.setObjectName(u"CADASTRO_es")
        CADASTRO_es.resize(956, 325)
        CADASTRO_es.setStyleSheet(u"background-color: rgb(0, 80, 121);")
        self.verticalLayout = QVBoxLayout(CADASTRO_es)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.frame_4 = QFrame(CADASTRO_es)
...
"}")
        ...
        self.retranslateUi(CADASTRO_es)

        QMetaObject.connectSlotsByName(CADASTRO_es)
    # setupUi

    def retranslateUi(self, CADASTRO_es):
        CADASTRO_es.setWindowTitle(QCoreApplication.translate("CADASTRO_es", u"Dialog", None))
        self.label_13.setText(QCoreApplication.translate("CADASTRO_es", u"<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; font-weight:600; color:#ffffff;\">CADASTRO DE ESTOQUE</span></p></body></html>", None))
        self.label_14.setText("")
        self.label_erro.setText(QCoreApplication.translate("CADASTRO_es", u"<html><head/><body><p align=\"center\"><span style=\" font-size:9pt; font-weight:600; color:#ffffff;\">TODOS OS CAMPOS S\u00c3O OBRIGATORIOS*</span></p></body></html>", None))
        self.label_15.setText("")
        self.txt_win.setText("")
        self.txt_win.setPlaceholderText(QCoreApplication.translate("CADASTRO_es", u"PE\u00c7A", None))
        self.txt_hostname.setText("")
        self.txt_hostname.setPlaceholderText(QCoreApplication.translate("CADASTRO_es", u"QUANTIDADE", None))
        self.btn_cadastrar_pc.setText(QCoreApplication.translate("CADASTRO_es", u"SALVAR", None))
        self.bnt_voltar_cad.setText(QCoreApplication.translate("CADASTRO_es", u"VOLTAR", None))
    # retranslateUi
