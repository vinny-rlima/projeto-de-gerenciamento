...
################################################################################
## Form generated from reading UI file 'ui_atualizar_es.ui'
##
...
class Ui_Atualizar_es(object):
    def setupUi(self, Atualizar_es):
        if not Atualizar_es.objectName():
            Atualizar_es.setObjectName(u"Atualizar_es")
        Atualizar_es.resize(614, 429)
        Atualizar_es.setStyleSheet(u"background-color: rgb(0, 80, 121);")
        self.horizontalLayout_2 = QHBoxLayout(Atualizar_es)
        self.horizontalLayout_2.setObjectName(u"horizontalLayout_2")
        self.widget = QWidget(Atualizar_es)
...
"}")
        ...
        self.retranslateUi(Atualizar_es)

        QMetaObject.connectSlotsByName(Atualizar_es)
    # setupUi

    def retranslateUi(self, Atualizar_es):
        Atualizar_es.setWindowTitle(QCoreApplication.translate("Atualizar_es", u"Dialog", None))
        self.label.setText(QCoreApplication.translate("Atualizar_es", u"<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; font-weight:600; color:#ffffff;\">ATUALIZAR ESTOQUE</span></p></body></html>", None))
        ___qtablewidgetitem = self.tab_atualizar.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("Atualizar_es", u"ID", None));
        ___qtablewidgetitem1 = self.tab_atualizar.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("Atualizar_es", u"PRODUTO", None));
        ___qtablewidgetitem2 = self.tab_atualizar.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("Atualizar_es", u"QUANTIDADE", None));
        self.btn_atualizar_pc.setText(QCoreApplication.translate("Atualizar_es", u"ATUALIZAR", None))
        self.bnt_voltar_atualizar.setText(QCoreApplication.translate("Atualizar_es", u"VOLTAR", None))
    # retranslateUi
